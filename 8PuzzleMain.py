...
def draw_buttons(screen,font):
    pygame.draw.rect(screen,(0,200,0),(0,300,WIDTH//2,BUTTON_HEIGHT))
    pygame.draw.rect(screen,(200,0,0),(WIDTH//2,300,WIDTH//2,BUTTON_HEIGHT))
    pygame.draw.rect(screen,(0,0,200),(2*WIDTH//3,300,WIDTH//3,BUTTON_HEIGHT))
    
    bfs_text=font.render("BFS",True,(255,255,255))
    astar_text=font.render("A*",True,(255,255,255))
    reset_text=font.render("Reset",True,(255,255,255))

    screen.blit(bfs_text,(WIDTH//6-20,310))
    screen.blit(astar_text,(3*WIDTH//2-20,310))
    screen.blit(reset_text,(5*WIDTH//6-30,310))
